...
$fnameError = $lnameError = $emailError = $dateError = $passError = $imgError = '';
if (isset($_POST['btn-signup'])) {
    ...
    $uploadError = '';
    $image = user_file_upload($_FILES['image']);
    ...
    if (!$error) {
        ...
        $query = "INSERT INTO user(first_name, last_name, password, date_of_birth, email, image)
                  VALUES('$fname', '$lname', '$password', '$date_of_birth', '$email', '$image->fileName')";
...
<div class="container">
   <form class="w-75" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" enctype="multipart/form-data">
            ...
            <hr/>
            <a href="user_index.php">Sign in Here...</a>
   </form>
   </div>
</body>
</html>