...
if ($_POST) {
    $id = $_POST['id'];
    $image = $_POST['image'];
    ($image =="avatar.png")?: unlink("../userimages/$image");
...
<fieldset>
<legend class='h2 mb-3'>Delete request <img class='img-thumbnail rounded-circle' src='../userimages/<?php echo $image ?>' alt="<?php echo $f_name ?>"></legend>
